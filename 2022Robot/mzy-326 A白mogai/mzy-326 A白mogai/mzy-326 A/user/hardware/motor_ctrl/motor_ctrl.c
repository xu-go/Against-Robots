...
/*------------------------------------------------------*/
	...
	else if(num==1)
	{
		...
		else if(l4==0 && l5 == 1 && flag.senor == TRUE) 	//else if(l3==0 && l4 == 1 && flag.senor == TRUE) 
		{
			num--;
			stop();
		}
...
/*------------------------------------------------------*/
	if(num>=1)
	{
		if(l5==1) //l3����ʮ��·����speed=lowʱ������
		{
			back();
			flag.senor = TRUE;
		}		
		if(l4==0 && flag.senor == TRUE)//if(l4==0 && flag.senor == TRUE)
		{
			num--;
			flag.senor = FALSE; //ֱ�б�־λΪ0����ʱnum���������ֹһ�����߼����
	  }
...
//		motor_speed(5600,-5600,5600,-5600);//lf rf lb rb
	  go_high(1880);//ƫ���һ�����?ֵ,ֵԽ���������Խ��?2200
	//300  1980
	else if(left_2) 
		go_high(2200);//3000 2400

	else if(left_3) 
		go_high(2700);//��������
	
	else if(right_1) 
		go_high(-400);//ƫ�Ҽ�һ����תֵ,ֵԽ���������Խ��?-400
