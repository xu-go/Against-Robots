...
typedef struct
{
  uint32_t StdId;  /*!< Specifies the standard identifier.
                        This parameter can be a value between 0 to 0x7FF. 指定标准标识符。*/

  uint32_t ExtId;  /*!< Specifies the extended identifier.
                        This parameter can be a value between 0 to 0x1FFFFFFF. 扩展标识符，应该用不到*/

  uint8_t IDE;     /*!< Specifies the type of identifier for the message that 
                        will be transmitted. This parameter can be a value 
                        of @ref CAN_identifier_type 指定要传输的消息的标识符类型*/

  uint8_t RTR;     /*!< Specifies the type of frame for the message that will 
                        be transmitted. This parameter can be a value of 
                        @ref CAN_remote_transmission_request指定将要传输的消息的帧类型 */
...
typedef struct
{
  ...
  uint8_t FMI;     /*!< Specifies the index of the filter the message stored in 
                        ...
                        value between 0 to 0xFF指定存储在邮箱中的邮件通过的筛选器的索引 */
} CanRxMsg;
