...
#define TEST 0
#define GAME 1
#define MODE  1 //(选择TEST是遥控器测试状态，选择GAME是比赛状态)

#define PALST_COMPS_YAW        (8)     //陀螺仪YAW角速度补偿

//底盘旋转跟随PID
#define CHASSIS_FOLLOW_GIMBAL_PID_KP 575.0f//580.0																																																																																																							
#define CHASSIS_FOLLOW_GIMBAL_PID_KI 0.882f //0.001
#define CHASSIS_FOLLOW_GIMBAL_PID_KD 0.28f   //0.8
